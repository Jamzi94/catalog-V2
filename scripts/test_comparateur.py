...
assert comparer("[SuperPSX]-EA.Sports.UFC.5-PPSA03541-EUR-Game (v01.031)-PS5.part01.rar",
                "[v01.031 · PKG · APR-EMU] 1File #01") == []

# Version contredite
e = comparer("[SuperPSX]-Jeu-PPSA00001-EUR-Game (v01.005)-PS5.rar", "[v01.031 · PKG] Viki")
assert any("version" in x for x in e), e

# Region contredite
e = comparer("[SuperPSX]-Jeu-PPSA00001-USA-Game (v01.031)-PS5.rar", "[v01.031 · PKG · EUR] Viki")
...
assert comparer("Jeu-PS5.part07.rar", "[PKG] Viki #03") == []
assert comparer("Jeu-PS5.part03.rar", "[PKG] Viki #03") == []

# Mention forte perdue
e = comparer("[SuperPSX]-Jeu-PPSA00001-EUR-DLC-PS5.rar", "[PKG] Viki")
...
assert comparer("file.rar", "[PKG] Viki") == []
assert not mesurable("file.rar", "[PKG] Viki")
assert mesurable("PPSA31246.exfat", "[PKG] Viki #02")

# Lecture des deux cotes
assert lire_nom("PPSA31246.exfat")["formats"] == ["exFAT"]
assert lire_etiquette("[v01.031 · Backport 4.xx · EUR] Viki #02") == {
...
assert comparer("Jeu V1.000 PPSA00001.rar", "[v01.000 · PKG] Viki") == []
assert comparer("Jeu 01.00 PPSA00001.rar", "[v01.000 · PKG] Viki") == []
# ... mais une VRAIE difference reste vue.
assert comparer("Jeu V1.005 PPSA00001.rar", "[v01.031 · PKG] Viki") != []
...
assert comparer("PPSA31246.exfat", "[BP 4.xx] Viki", group="Backport 4.xx") == []
assert comparer("PPSA31246.exfat", "[BP] Viki", group="Backport") != []   # sans N.xx : rien n'est implique
...
e = comparer("Jeu-PPSA00001-PKG-PS5.pkg", "[BP 4.xx] Viki", group="Backport 4.xx")
assert e, e
...
e = comparer("Jeu-PS5.part07.rar", "[PKG] Viki 03/10")
...
assert comparer("Jeu-PPSA00001-Backport-PS5.rar", "[BP 4.xx] Viki") == []
assert comparer("Jeu-PPSA00001-Backport-PS5.rar", "[PKG] Viki") != []
